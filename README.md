# WUT-Thesis ![Travis (.org) branch](https://img.shields.io/travis/ArturB/WUT-Thesis/master?label=texlive) ![Travis (.org) branch](https://img.shields.io/travis/ArturB/WUT-Thesis/master?label=miktex)
